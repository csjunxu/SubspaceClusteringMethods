function [data trueLabels mask] = load_sequence(sequenceDir,sequenceName, normalizeData)
...
SEQUENCE_FOLDER_NAME = sequenceDir;
fileName = [ SEQUENCE_FOLDER_NAME '/' sequenceName];
load(fileName);
